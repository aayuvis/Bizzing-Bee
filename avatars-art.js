...
(function(){
  ...
  function base(o){ var skin=o.skin, jaw=o.jaw, k=o.k;
    ...
    var eyes = o.eyes || (o.closed
      ...
      : '<ellipse cx="52" cy="52" rx="4.5" ry="5.3" fill="#fff"/><circle cx="52.6" cy="52.7" r="2.5" fill="'+P+'"/><circle cx="51.4" cy="51.2" r=".9" fill="#fff"/><ellipse cx="68" cy="52" rx="4.5" ry="5.3" fill="#fff"/><circle cx="68.6" cy="52.7" r="2.5" fill="'+P+'"/><circle cx="67.4" cy="51.2" r=".9" fill="#fff"/>');
    var nose='<path d="M60 50 q-3.5 8 -1 12 q2.5 2.5 6 1.2" fill="none" stroke="'+jaw+'" stroke-width="1.3" opacity=".5"/>';
    var cheeks='<circle cx="46" cy="62" r="3.6" fill="#FF9EB8" opacity=".55"/><circle cx="74" cy="62" r="3.6" fill="#FF9EB8" opacity=".55"/>';
    var mouth = o.mouth || '<path d="M54 69 q6 3.4 12 0" stroke="'+jaw+'" stroke-width="2" fill="none" stroke-linecap="round"/>';
    return {neck:neck,shoulders:shoulders,face:face,ears:ears,jshade:jshade,eyes:eyes,nose:nose,cheeks:cheeks,mouth:mouth};
  }
  ...
  A.thor=fig({k:'thor',skin:'#F2D4B8',jaw:'#D9B492',g1:'#5B6B84',g2:'#3C485C',
    ...
    prop:'<g transform="translate(20 98)"><rect x="-11" y="-9" width="22" height="17" rx="3" fill="#7A8494" stroke="#5A6472" stroke-width="1.4"/><rect x="-2" y="7" width="4" height="15" rx="1.5" fill="#6B4A2A"/><path d="M-7 -4 h14 M-7 0 h14 M-7 4 h14" stroke="#5A6472" stroke-width="1"/><circle cx="0" cy="0" r="3" fill="none" stroke="#B8C2D2" stroke-width="1.2"/></g><path d="M12 84 l1 3 l3 1 l-3 1 l-1 3 l-1 -3 l-3 -1 l3 -1z" fill="#FFD34D"/>',
  ...
  A.zeus=fig({k:'zeus',skin:'#F0D2B0',jaw:'#D4B189',g1:'#EFE9DC',g2:'#D2C8B4',
    ...
    prop:'<path d="M16 82 l6 10 l-6 2 l9 14 l-3 -11 l6 -2z" fill="#FFD34D" stroke="#D4A82A" stroke-width="1"/><g transform="translate(99 98)"><path d="M-6 0 Q-6 -6 0 -6 Q7 -6 7 2 Q3 -1 -2 2z" fill="#7A5A34"/><path d="M4 -3 l5 -1 l-4 3z" fill="#E8A94C"/><circle cx="1" cy="-2" r="1" fill="#2A2018"/></g>',
  ...
  A.poseidon=fig({k:'poseidon',skin:'#E6CBA6',jaw:'#C9AA80',g1:'#2E9AA6',g2:'#1A6670',
    ...
    prop:'<g transform="translate(18 90)"><rect x="-1.5" y="-14" width="3" height="34" rx="1.5" fill="#C9A24A"/><path d="M-9 -14 q0 8 9 8 q9 0 9 -8 M-9 -14 v6 M9 -14 v6 M0 -14 v8" stroke="#E8C24A" stroke-width="2.4" fill="none"/><circle cx="0" cy="-15" r="2" fill="#FFD34D"/></g>',
  ...
  A.rama=fig({k:'rama',skin:'#88ACDE',jaw:'#6A8EC0',g1:'#E8B84A',g2:'#C8952A',
    ...
    prop:'<path d="M20 56 Q9 84 20 112" fill="none" stroke="#C8952A" stroke-width="2.6"/><path d="M20 56 Q9 84 20 112" fill="none" stroke="#F0D26A" stroke-width="1" stroke-dasharray="1 3"/><line x1="20" y1="56" x2="20" y2="112" stroke="#8A6A2A" stroke-width="1"/>',
  ...
  A.krishna=fig({k:'krishna',skin:'#7AA4DC',jaw:'#5C86BE',g1:'#E8C24A',g2:'#C89A28',
    ...
    prop:'<g transform="translate(15 80) rotate(26)"><rect x="0" y="0" width="42" height="4.4" rx="2.2" fill="#C98A34" stroke="#8A5E22" stroke-width=".8"/><circle cx="10" cy="2.2" r="1" fill="#6A4418"/><circle cx="18" cy="2.2" r="1" fill="#6A4418"/><circle cx="26" cy="2.2" r="1" fill="#6A4418"/><circle cx="34" cy="2.2" r="1" fill="#6A4418"/></g><g transform="translate(98 104)"><path d="M-6 -4 Q-8 6 0 6 Q8 6 6 -4 Z" fill="#E8D8B0" stroke="#C9B380" stroke-width="1"/><ellipse cx="0" cy="-4" rx="6" ry="2" fill="#F0E4C4"/></g>',
