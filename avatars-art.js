...
/* ===== GODS PACK — myth-framed deities as portrait avatars (pack 20). Same portrait
   formula as World Changers: sculpted face + neck + sloped shoulders, likeness in
   crown/hair/facial-hair + attribute props. Ra & Anubis use animal heads (animal:true
   swaps the human face for a falcon / jackal head). Venerated figures (Rama, Krishna,
   Shiva) are drawn reverently — serene, never mocked; none are villains. 120x120. ===== */
(function(){
  var P='#2E455C';
  function G(id,a,b){ return '<radialGradient id="'+id+'" cx="50%" cy="26%" r="82%"><stop offset="0" stop-color="'+a+'"/><stop offset="1" stop-color="'+b+'"/></radialGradient>'; }
  function base(o){ var skin=o.skin, jaw=o.jaw, k=o.k;
    var neck='<path d="M52 72 h16 v11 q-8 4 -16 0 z" fill="'+skin+'"/><path d="M52 74 q8 3.5 16 0" stroke="'+jaw+'" stroke-width="1.4" fill="none" opacity=".5"/>';
    var shoulders='<path d="M22 120 Q25 93 60 86 Q95 93 98 120 Z" fill="url(#gg-'+k+')"/>';
    var face='<path d="M38 46 Q37 25 60 23 Q83 25 82 46 Q82 63 72 73 Q66 80 60 80 Q54 80 48 73 Q38 63 38 46 Z" fill="'+skin+'"/>';
    var ears='<ellipse cx="37" cy="54" rx="4.6" ry="6.8" fill="'+skin+'"/><path d="M35.6 52 q2 2 0 4.6" stroke="'+jaw+'" stroke-width="1.1" fill="none"/><ellipse cx="83" cy="54" rx="4.6" ry="6.8" fill="'+skin+'"/><path d="M84.4 52 q-2 2 0 4.6" stroke="'+jaw+'" stroke-width="1.1" fill="none"/>';
    var jshade='<path d="M48 72 Q60 81 72 72 Q66 77 60 77 Q54 77 48 72 Z" fill="'+jaw+'" opacity=".32"/>';
    var eyes = o.eyes || (o.closed
      ? '<path d="M46 53 q6 4.5 12 0" stroke="'+P+'" stroke-width="2" fill="none" stroke-linecap="round"/><path d="M62 53 q6 4.5 12 0" stroke="'+P+'" stroke-width="2" fill="none" stroke-linecap="round"/>'
      : '<ellipse cx="51.5" cy="53" rx="5.7" ry="6.6" fill="#fff"/><circle cx="52.4" cy="54" r="3.4" fill="'+P+'"/><circle cx="50.6" cy="51.6" r="1.4" fill="#fff"/><circle cx="53.6" cy="55.4" r=".7" fill="#fff" opacity=".8"/><ellipse cx="68.5" cy="53" rx="5.7" ry="6.6" fill="#fff"/><circle cx="69.4" cy="54" r="3.4" fill="'+P+'"/><circle cx="67.6" cy="51.6" r="1.4" fill="#fff"/><circle cx="70.6" cy="55.4" r=".7" fill="#fff" opacity=".8"/>');
    var nose='<path d="M60 52 q-2.5 6 -.5 9 q2 1.8 4.5 .8" fill="none" stroke="'+jaw+'" stroke-width="1.2" opacity=".45"/>';
    var cheeks='<circle cx="44.5" cy="64" r="4.6" fill="#FF9EB8" opacity=".7"/><circle cx="75.5" cy="64" r="4.6" fill="#FF9EB8" opacity=".7"/>';
    var mouth = o.mouth || '<path d="M53 69 q7 4.6 14 0" stroke="'+jaw+'" stroke-width="2.2" fill="none" stroke-linecap="round"/>';
    return {neck:neck,shoulders:shoulders,face:face,ears:ears,jshade:jshade,eyes:eyes,nose:nose,cheeks:cheeks,mouth:mouth};
  }
  var spark='<path d="M22 24 l1.2 2.6 l2.6 1.2 l-2.6 1.2 l-1.2 2.6 l-1.2 -2.6 l-2.6 -1.2 l2.6 -1.2z" fill="#FFC83D"/><path d="M99 20 l1.3 2.8 l2.8 1.3 l-2.8 1.3 l-1.3 2.8 l-1.3 -2.8 l-2.8 -1.3 l2.8 -1.3z" fill="#FFC83D"/>';
  function fig(o){
    var b=base(o);
    var head = o.animal
      ? (o.head||'')
      : b.face+b.ears+b.jshade+(o.hairFront||'')+b.eyes+(o.spec||'')+b.nose+b.cheeks+(o.mouth?o.mouth:b.mouth)+(o.facial||'')+(o.head||'');
    return '<defs>'+G('gg-'+o.k,o.g1,o.g2)+(o.defs||'')+'</defs>'
      +(o.backdrop||'')+b.neck+b.shoulders+(o.collar||'')+(o.behind||'')
      +head+(o.prop||'')+spark;
  }
  var A={};
  // ---- Thor — winged helm, red beard, Mjolnir + glow, storm clouds, chainmail ----
  A.thor=fig({k:'thor',skin:'#F2D4B8',jaw:'#D9B492',g1:'#5B6B84',g2:'#3C485C',
    backdrop:'<path d="M6 30 q6 -8 16 -5 q4 -8 14 -4 q6 -6 12 2 q-4 8 -14 6 q-6 6 -16 2 q-8 3 -12 -3z" fill="#8A94A6" opacity=".45"/><path d="M40 20 l4 8 l-6 1 l7 10" stroke="#FFD34D" stroke-width="2.4" fill="none" stroke-linecap="round"/>',
    head:'<path d="M34 42 Q32 18 60 16 Q88 18 86 42 Q80 26 60 24 Q40 26 34 42 Z" fill="#9AA6B8" stroke="#B8C2D2" stroke-width="1.1"/><rect x="57.5" y="24" width="5" height="20" rx="2.5" fill="#8A96A8"/><path d="M36 34 Q16 24 8 30 Q20 32 22 38 Q12 36 8 42 Q22 44 36 42 Q30 38 34 34z" fill="#EDEFF2" stroke="#C6CEDA" stroke-width="1"/><path d="M84 34 Q104 24 112 30 Q100 32 98 38 Q108 36 112 42 Q98 44 84 42 Q90 38 86 34z" fill="#EDEFF2" stroke="#C6CEDA" stroke-width="1"/>',
    facial:'<path d="M42 58 Q44 82 60 86 Q76 82 78 58 Q68 72 60 72 Q52 72 42 58 Z" fill="#B4472A"/><path d="M50 63 q10 5 20 0" stroke="#9A3A22" stroke-width="1.4" fill="none"/><path d="M50 59 q10 4 20 0" stroke="#C25636" stroke-width="3" fill="none" stroke-linecap="round"/>',
    prop:'<g transform="translate(92 84)"><circle cx="0" cy="-1" r="21" fill="#FFD34D" opacity=".26"/><rect x="-2.6" y="6" width="5.2" height="24" rx="2.2" fill="#7A5230"/><path d="M-2.6 8 h5.2 M-2.6 12 h5.2" stroke="#5A3A20" stroke-width="1"/><rect x="-15" y="-13" width="30" height="23" rx="4.5" fill="#9AA6B8" stroke="#5A6472" stroke-width="2.2"/><rect x="-15" y="-13" width="30" height="8" rx="4.5" fill="#B8C2D2"/><path d="M-10 -5 h20 M-10 1 h20 M-10 6 h20" stroke="#6A7690" stroke-width="1.1"/><circle cx="0" cy="-1" r="4.4" fill="none" stroke="#D6DEE8" stroke-width="1.8"/><path d="M0 -5 l0 8 M-4 -1 l8 0" stroke="#D6DEE8" stroke-width="1.4"/></g><path d="M74 60 l3.5 7 -5 1.5 7 9.5" stroke="#FFD34D" stroke-width="2.6" fill="none" stroke-linecap="round" stroke-linejoin="round"/>',
    collar:'<path d="M40 120 Q44 94 60 88 Q76 94 80 120 Z" fill="#4A5568"/><g fill="#6A7690"><circle cx="50" cy="100" r="1.9"/><circle cx="58" cy="98" r="1.9"/><circle cx="66" cy="98" r="1.9"/><circle cx="74" cy="100" r="1.9"/><circle cx="54" cy="108" r="1.9"/><circle cx="62" cy="106" r="1.9"/><circle cx="70" cy="108" r="1.9"/></g>' });
  // ---- Zeus — laurel wreath, white beard, gold bolt, temple columns, eagle ----
  A.zeus=fig({k:'zeus',skin:'#F0D2B0',jaw:'#D4B189',g1:'#EFE9DC',g2:'#D2C8B4',
    backdrop:'<g fill="#E6DFCE" opacity=".5"><rect x="8" y="40" width="9" height="60" rx="1"/><rect x="103" y="40" width="9" height="60" rx="1"/><rect x="4" y="36" width="17" height="6" rx="1"/><rect x="99" y="36" width="17" height="6" rx="1"/></g>',
    behind:'<path d="M34 40 Q32 20 60 18 Q88 20 86 40 Q80 28 60 27 Q40 28 34 40 Z" fill="#EDEAE2"/>',
    head:'<g fill="#C6A63A"><path d="M34 40 Q30 30 40 26 Q46 30 50 27 Q42 34 44 42z"/><path d="M86 40 Q90 30 80 26 Q74 30 70 27 Q78 34 76 42z"/></g><g fill="#3E8A3A"><ellipse cx="40" cy="30" rx="3.4" ry="2" transform="rotate(-30 40 30)"/><ellipse cx="48" cy="26" rx="3.4" ry="2" transform="rotate(-15 48 26)"/><ellipse cx="72" cy="26" rx="3.4" ry="2" transform="rotate(15 72 26)"/><ellipse cx="80" cy="30" rx="3.4" ry="2" transform="rotate(30 80 30)"/></g>',
    facial:'<path d="M40 58 Q42 86 60 90 Q78 86 80 58 Q68 74 60 74 Q52 74 40 58 Z" fill="#EDEAE2"/><path d="M48 62 q12 5 24 0" stroke="#DCD8CE" stroke-width="3" fill="none" stroke-linecap="round"/>',
    prop:'<g transform="translate(18 86)"><circle cx="0" cy="0" r="19" fill="#FFD34D" opacity=".22"/><path d="M7 -20 l-13 18 l7 1.5 l-9 17 l17 -21 l-7.5 -1.5 z" fill="#FFD34D" stroke="#E0A81E" stroke-width="1.6" stroke-linejoin="round"/><path d="M7 -20 l-13 18 l7 1.5" fill="none" stroke="#FFF3B0" stroke-width="1.1" opacity=".8"/></g><g transform="translate(99 98)"><path d="M-6 0 Q-6 -6 0 -6 Q7 -6 7 2 Q3 -1 -2 2z" fill="#7A5A34"/><path d="M4 -3 l5 -1 l-4 3z" fill="#E8A94C"/><circle cx="1" cy="-2" r="1" fill="#2A2018"/></g>',
    collar:'<path d="M42 120 Q46 94 60 87 Q74 94 78 120 Z" fill="#E7E1D2"/><path d="M60 87 Q54 104 46 120 M60 87 Q66 104 74 120" stroke="#CFC7B4" stroke-width="1.4" fill="none"/><g stroke="#B89A3A" stroke-width="1.6" fill="none"><path d="M48 114 h6 v-4 h4 v4 h6"/></g>' });
  // ---- Poseidon — coral crown, sea-green beard, glowing trident, waves, starfish ----
  A.poseidon=fig({k:'poseidon',skin:'#E6CBA6',jaw:'#C9AA80',g1:'#2E9AA6',g2:'#1A6670',
    backdrop:'<path d="M4 96 q10 -8 20 0 t20 0 t20 0 t20 0 t20 0" fill="none" stroke="#4FB8C4" stroke-width="3" opacity=".55"/><path d="M4 106 q10 -8 20 0 t20 0 t20 0 t20 0 t20 0" fill="none" stroke="#4FB8C4" stroke-width="3" opacity=".38"/><path d="M14 82 l2.4 2.4 -2.4 2.4 -2.4 -2.4z M14 78 l0 12 M8 84 l12 0 M11 80 l6 8 M17 80 l-6 8" stroke="#F4A0B0" stroke-width="1.3" fill="#F4A0B0"/>',
    head:'<g fill="#E87A54"><path d="M40 30 Q38 20 44 16 Q46 22 50 20 Q48 26 52 28z"/><path d="M80 30 Q82 20 76 16 Q74 22 70 20 Q72 26 68 28z"/><path d="M52 24 Q56 14 60 22 Q64 14 68 24 Q64 20 60 24 Q56 20 52 24z"/></g><g fill="#F2A07E"><circle cx="44" cy="17" r="2"/><circle cx="60" cy="16" r="2"/><circle cx="76" cy="17" r="2"/></g>',
    facial:'<path d="M40 58 Q42 84 60 88 Q78 84 80 58 Q68 72 60 72 Q52 72 40 58 Z" fill="#3FA8B0"/><path d="M48 62 q12 5 24 0" stroke="#2E8A92" stroke-width="3" fill="none" stroke-linecap="round"/>',
    prop:'<g transform="translate(17 86)"><circle cx="0" cy="-13" r="13" fill="#4FB8C4" opacity=".22"/><rect x="-2" y="-13" width="4" height="38" rx="2" fill="#C9A24A"/><path d="M-11 -13 q0 10 11 10 q11 0 11 -10 M-11 -16 v7 M11 -16 v7 M0 -16 v9" stroke="#E8C24A" stroke-width="3.2" fill="none" stroke-linecap="round"/><circle cx="0" cy="-18" r="2.4" fill="#FFD34D"/></g>',
    collar:'<path d="M42 120 Q46 94 60 87 Q74 94 78 120 Z" fill="#2A8C96"/><path d="M48 100 q12 6 24 0 M48 108 q12 6 24 0" stroke="#4FB8C4" stroke-width="2" fill="none"/>' });
  // ---- Ra — falcon head, sun disk + cobra, 4-row wing collar, pyramids + Nile ----
  A.ra=fig({k:'ra',animal:true,skin:'#C99A5A',jaw:'#A97E42',g1:'#E8DFC8',g2:'#C9BB94',
    backdrop:'<g fill="#E8C878" opacity=".5"><path d="M2 100 L18 66 L34 100z"/><path d="M30 100 L50 58 L70 100z"/></g><path d="M2 104 q12 -4 24 0 t24 0 t24 0 t24 0" fill="none" stroke="#5AA0D0" stroke-width="2.4" opacity=".5"/><g stroke="#B89A5A" stroke-width="1.3" fill="none" opacity=".7"><path d="M100 24 v8 M104 24 v8 M108 26 v6"/><circle cx="100" cy="20" r="1.6"/></g>',
    head:'<circle cx="60" cy="12" r="10" fill="#E8503E"/><circle cx="60" cy="12" r="10" fill="none" stroke="#FFC83D" stroke-width="1.4"/><path d="M53 14 q-4 2 -3 7 q3 -1 4 -4z" fill="#2A7A4E"/><path d="M40 46 Q36 20 60 20 Q84 20 80 46 Q78 58 68 66 L60 68 L53 64 Q42 56 40 46 Z" fill="#8FA0AE"/><path d="M40 46 Q42 34 50 30 M80 46 Q78 34 70 30" stroke="#6E8090" stroke-width="1.5" fill="none"/><path d="M58 56 Q49 58 51 66 Q58 66 62 60 Z" fill="#E8A94C"/><path d="M58 56 Q49 58 51 66" stroke="#C98A34" stroke-width="1" fill="none"/><circle cx="67" cy="46" r="4.6" fill="#fff"/><circle cx="67.6" cy="46.6" r="2.6" fill="#2A2018"/><circle cx="66.6" cy="45.4" r=".9" fill="#fff"/><path d="M71 48 q6 1 9 5 M62 52 q-1 4 -4 6" stroke="#2A2018" stroke-width="1.3" fill="none"/><path d="M46 42 q3 -3 7 -1" stroke="#2A2018" stroke-width="1.3" fill="none"/>',
    collar:'<path d="M38 120 Q42 92 60 86 Q78 92 82 120 Z" fill="#E8DFC8"/><path d="M44 96 Q60 106 76 96" stroke="#D4A82A" stroke-width="4" fill="none"/><path d="M42 102 Q60 114 78 102" stroke="#2E9AA6" stroke-width="4" fill="none"/><path d="M41 108 Q60 121 79 108" stroke="#C43A44" stroke-width="4" fill="none"/><path d="M40 114 Q60 127 80 114" stroke="#D4A82A" stroke-width="4" fill="none"/>' });
  // ---- Athena — plumed helm, owl, aegis, Parthenon pediment, Greek-key hem ----
  A.athena=fig({k:'athena',skin:'#F2D4B8',jaw:'#D9B492',g1:'#E7E1D0',g2:'#CDC4AC',
    backdrop:'<path d="M14 40 L60 14 L106 40 Z" fill="#E0D8C4" opacity=".45"/><path d="M14 40 L106 40" stroke="#CBBF9E" stroke-width="2" opacity=".5"/>',
    behind:'<path d="M33 48 Q31 28 60 26 Q89 28 87 48 Q84 36 60 35 Q36 36 33 48 Z" fill="#5A4632"/>',
    head:'<path d="M52 4 Q60 0 68 4 Q66 14 60 16 Q54 14 52 4z" fill="#C43A44"/><path d="M62 5 Q78 8 74 22 L70 20 Q72 12 62 9z" fill="#A83039"/><path d="M34 40 Q32 16 60 14 Q88 16 86 40 Q86 30 78 26 L78 40 Q70 22 60 22 Q50 22 42 40 L42 26 Q34 30 34 40z" fill="#C6A63A"/><rect x="57.5" y="22" width="5" height="20" rx="2.5" fill="#B0902E"/>',
    prop:'<g transform="translate(22 100)"><ellipse cx="0" cy="0" rx="8" ry="9" fill="#A9752E"/><path d="M-8 -1 Q0 6 8 -1" fill="#8A5E22"/><circle cx="-3" cy="-2" r="2.4" fill="#FFD34D"/><circle cx="3" cy="-2" r="2.4" fill="#FFD34D"/><circle cx="-3" cy="-2" r="1" fill="#2A2018"/><circle cx="3" cy="-2" r="1" fill="#2A2018"/><path d="M0 1 l-2 3 l4 0z" fill="#E8A94C"/><path d="M-8 -6 l-3 -3 M8 -6 l3 -3" stroke="#8A5E22" stroke-width="1.6"/></g>',
    collar:'<path d="M42 120 Q46 94 60 87 Q74 94 78 120 Z" fill="#E4DECC"/><g stroke="#B89A3A" stroke-width="1.6" fill="none"><path d="M47 116 h5 v-4 h4 v4 h5 v-4 h4 v4 h4"/></g>' });
  // ---- Rama — blue prince, jeweled crown + tilak, great bow, garland, golden halo ----
  A.rama=fig({k:'rama',skin:'#88ACDE',jaw:'#6A8EC0',g1:'#E8B84A',g2:'#C8952A',
    backdrop:'<circle cx="60" cy="44" r="40" fill="#FFD86B" opacity=".32"/><circle cx="60" cy="44" r="40" fill="none" stroke="#FFC83D" stroke-width="1.4" opacity=".55"/>',
    behind:'<path d="M34 46 Q32 26 60 24 Q88 26 86 46 Q84 32 60 31 Q36 32 34 46 Z" fill="#1E2A44"/>',
    head:'<path d="M40 26 Q40 10 60 8 Q80 10 80 26 Q72 16 60 16 Q48 16 40 26 Z" fill="#E8C24A"/><path d="M60 4 L64 14 L56 14 Z" fill="#F0D24A"/><g fill="#E85A6B"><circle cx="48" cy="20" r="2"/><circle cx="60" cy="16" r="2.4"/><circle cx="72" cy="20" r="2"/></g>',
    spec:'<path d="M60 30 L60 40" stroke="#D6362E" stroke-width="2.2" stroke-linecap="round"/>',
    prop:'<path d="M20 48 Q3 84 20 120" fill="none" stroke="#C8952A" stroke-width="3.6" stroke-linecap="round"/><path d="M20 48 Q3 84 20 120" fill="none" stroke="#F0D26A" stroke-width="1.3"/><line x1="20" y1="49" x2="20" y2="119" stroke="#EDE7D6" stroke-width="1.4"/><line x1="20" y1="84" x2="50" y2="84" stroke="#8A6A2A" stroke-width="2.2"/><path d="M50 84 l-6 -3.4 M50 84 l-6 3.4" stroke="#8A6A2A" stroke-width="2.2" fill="none" stroke-linecap="round"/><path d="M20 81 l0 6 l4 -3z" fill="#E8B84A" stroke="#8A6A2A" stroke-width=".8"/>',
    collar:'<path d="M42 120 Q46 92 60 86 Q74 92 78 120 Z" fill="#E0B040"/><path d="M46 92 Q60 102 74 92" fill="none" stroke="#E85A6B" stroke-width="3"/><g fill="#F0E0A0"><circle cx="50" cy="98" r="2.4"/><circle cx="58" cy="102" r="2.4"/><circle cx="66" cy="102" r="2.4"/><circle cx="74" cy="98" r="2.4"/></g>' });
  // ---- Hades — violet flame hair, easy grin, bident, soul wisps, Cerberus pup ----
  A.hades=fig({k:'hades',skin:'#D8CBBC',jaw:'#B8AB9C',g1:'#4A3A6E',g2:'#2A2044',closed:true,
    mouth:'<path d="M53 68 q7 4 14 0" stroke="#8A6A5A" stroke-width="2" fill="none" stroke-linecap="round"/>',
    backdrop:'<path d="M0 120 Q20 90 10 70 Q30 88 40 74 Q44 96 60 92 Q76 96 80 74 Q90 88 110 70 Q100 90 120 120 Z" fill="#241C36" opacity=".45"/><circle cx="24" cy="40" r="4" fill="#B8A0E0" opacity=".5"/><circle cx="96" cy="34" r="3" fill="#B8A0E0" opacity=".45"/>',
    hairFront:'<path d="M36 44 Q30 20 40 14 Q40 26 46 28 Q40 14 52 8 Q52 22 58 26 Q56 8 68 8 Q66 22 72 26 Q72 12 80 16 Q76 28 82 30 Q84 20 88 26 Q86 38 80 44 Q70 30 60 30 Q48 30 36 44z" fill="#6E4AA6"/><g fill="#9A6ED8" opacity=".85"><path d="M46 24 Q48 14 54 12 Q52 22 46 24z"/><path d="M68 24 Q66 14 72 14 Q72 22 68 24z"/></g>',
    facial:'<path d="M48 66 Q52 78 60 80 Q68 78 72 66 Q66 74 60 74 Q54 74 48 66z" fill="#5A4E44"/>',
    prop:'<g transform="translate(18 92)"><rect x="-1.5" y="-14" width="3" height="32" rx="1.5" fill="#7A6A4A"/><path d="M-8 -12 Q-8 -18 -4 -18 M8 -12 Q8 -18 4 -18 M-4 -18 L-4 -8 M4 -18 L4 -8" stroke="#C9B36A" stroke-width="2.2" fill="none"/></g><g transform="translate(98 102)"><ellipse cx="0" cy="0" rx="7" ry="5.5" fill="#5A4E44"/><circle cx="-3" cy="-3" r="2.6" fill="#4A4038"/><circle cx="3" cy="-3" r="2.6" fill="#4A4038"/><circle cx="0" cy="-4" r="2.6" fill="#4A4038"/><circle cx="-3" cy="-3.4" r="1" fill="#FF7A4D"/><circle cx="3" cy="-3.4" r="1" fill="#FF7A4D"/><circle cx="0" cy="-4.4" r="1" fill="#FF7A4D"/></g>',
    collar:'<path d="M42 120 Q46 94 60 88 Q74 94 78 120 Z" fill="#3A2E58"/><path d="M52 92 q8 4 16 0 l0 5 q-8 4 -16 0z" fill="#5A4A82"/>' });
  // ---- Odin — wanderer hat, eyepatch, Gungnir, ravens, Yggdrasil branch, runes ----
  A.odin=fig({k:'odin',skin:'#E6CBA6',jaw:'#C6A87E',g1:'#5A5A64',g2:'#3A3A44',
    backdrop:'<path d="M100 8 Q104 30 100 60 M100 20 Q90 22 86 30 M100 34 Q110 36 114 44 M100 46 Q92 48 88 54" stroke="#4A6A3A" stroke-width="2" fill="none" opacity=".5"/><g fill="#8A8A94" opacity=".6"><path d="M8 24 l0 10 M8 24 l5 4 M8 29 l5 -3" stroke="#8A8A94" stroke-width="1.4"/><path d="M12 42 l0 10 M12 42 l4 5 M12 42 l-4 3" stroke="#8A8A94" stroke-width="1.4"/></g>',
    behind:'<path d="M32 50 Q30 32 60 30 Q90 32 88 50 Q84 38 60 37 Q36 38 32 50 Z" fill="#D8D2C6"/>',
    head:'<ellipse cx="60" cy="20" rx="34" ry="10" fill="#6B5A44"/><path d="M28 20 Q60 30 92 20 Q90 30 60 32 Q30 30 28 20z" fill="#5A4A36"/><path d="M44 14 Q60 6 76 14 Q68 10 60 10 Q52 10 44 14z" fill="#7A6A50"/>',
    eyes:'<ellipse cx="52" cy="52" rx="4.5" ry="5.3" fill="#fff"/><circle cx="52.6" cy="52.7" r="2.5" fill="#2E455C"/><circle cx="51.4" cy="51.2" r=".9" fill="#fff"/><path d="M63 49 L74 47 L75 55 L64 56 Z" fill="#2E2A2A"/><path d="M63 49 L54 45 M75 51 L84 49" stroke="#1E1A1A" stroke-width="1.4" fill="none"/>',
    facial:'<path d="M40 60 Q42 92 60 98 Q78 92 80 60 Q68 76 60 76 Q52 76 40 60 Z" fill="#D8D2C6"/><path d="M48 64 q12 5 24 0" stroke="#C2BCAE" stroke-width="3" fill="none" stroke-linecap="round"/>',
    prop:'<line x1="22" y1="42" x2="22" y2="116" stroke="#7A5A3A" stroke-width="2.4"/><path d="M22 42 L18 32 L22 28 L26 32 Z" fill="#B8C2D2" stroke="#8A94A4" stroke-width="1"/><g transform="translate(97 46)"><ellipse cx="0" cy="0" rx="7" ry="5" fill="#2A2A32"/><circle cx="6" cy="-2" r="4" fill="#2A2A32"/><path d="M9 -2 l4 -1 l-3 3z" fill="#3A3A42"/><circle cx="7" cy="-3" r="1" fill="#FFD34D"/><path d="M-6 3 l-6 4 M-4 4 l-5 6" stroke="#2A2A32" stroke-width="2"/></g>',
    collar:'<path d="M40 120 Q44 92 60 86 Q76 92 80 120 Z" fill="#4A4A54"/><path d="M40 100 Q60 94 80 100 L80 108 Q60 102 40 108 Z" fill="#8A8276" opacity=".8"/>' });
  // ---- Anubis — jackal head, gold-lined ears, scales, ankh, starry pyramid ----
  A.anubis=fig({k:'anubis',animal:true,skin:'#B98A52',jaw:'#986E3E',g1:'#2E2A34',g2:'#161420',
    backdrop:'<g fill="#4A4636" opacity=".5"><path d="M2 100 L20 62 L38 100z"/></g><g fill="#F0E08A" opacity=".7"><circle cx="96" cy="26" r="1.4"/><circle cx="104" cy="34" r="1.4"/><circle cx="88" cy="36" r="1.2"/><circle cx="110" cy="24" r="1.2"/></g>',
    head:'<path d="M40 34 L34 6 Q40 4 48 22 Z" fill="#1E1C26"/><path d="M40 34 L36 12 Q41 12 46 24 Z" fill="#C9A23A"/><path d="M80 34 L86 6 Q80 4 72 22 Z" fill="#1E1C26"/><path d="M80 34 L84 12 Q79 12 74 24 Z" fill="#C9A23A"/><path d="M40 44 Q38 24 60 22 Q82 24 80 44 Q80 56 72 62 L72 72 Q66 78 60 74 L58 62 Q42 58 40 44 Z" fill="#22202A"/><path d="M72 62 L84 70 Q80 76 72 74 Z" fill="#22202A"/><circle cx="80" cy="70" r="2.2" fill="#1A1822"/><circle cx="52" cy="46" r="4.4" fill="#F0E08A"/><circle cx="52.5" cy="46.5" r="2.3" fill="#1A1620"/><circle cx="68" cy="46" r="4.4" fill="#F0E08A"/><circle cx="68.5" cy="46.5" r="2.3" fill="#1A1620"/><path d="M48 42 l7 1 M72 42 l-7 1" stroke="#0E0C14" stroke-width="1.4"/>',
    prop:'<g transform="translate(20 96)"><line x1="0" y1="-16" x2="0" y2="16" stroke="#C9A23A" stroke-width="2"/><line x1="-12" y1="-12" x2="12" y2="-12" stroke="#C9A23A" stroke-width="2"/><path d="M-12 -12 L-16 -4 L-8 -4 Z" fill="none" stroke="#C9A23A" stroke-width="1.4"/><path d="M12 -12 L8 -4 L16 -4 Z" fill="none" stroke="#C9A23A" stroke-width="1.4"/><circle cx="-12" cy="-2" r="2" fill="#E85A6B"/><path d="M8 -3 l4 2 -4 2z" fill="#F0F0E0"/></g><g transform="translate(98 100)"><ellipse cx="0" cy="4" rx="4" ry="6" fill="none" stroke="#C9A23A" stroke-width="2"/><circle cx="0" cy="-4" r="4" fill="none" stroke="#C9A23A" stroke-width="2"/><line x1="0" y1="0" x2="0" y2="10" stroke="#C9A23A" stroke-width="2"/></g>',
    collar:'<path d="M38 120 Q42 92 60 86 Q78 92 82 120 Z" fill="#C9A23A"/><path d="M44 96 Q60 106 76 96" stroke="#2E7A88" stroke-width="4" fill="none"/><path d="M42 104 Q60 116 78 104" stroke="#1E1C26" stroke-width="4" fill="none"/><path d="M41 111 Q60 123 79 111" stroke="#C43A44" stroke-width="3.4" fill="none"/>' });
  // ---- Krishna — peacock feather, flute, garland, butter pot, Yamuna, golden halo ----
  A.krishna=fig({k:'krishna',skin:'#7AA4DC',jaw:'#5C86BE',g1:'#E8C24A',g2:'#C89A28',
    backdrop:'<circle cx="60" cy="44" r="40" fill="#FFE08A" opacity=".32"/><circle cx="60" cy="44" r="40" fill="none" stroke="#FFC83D" stroke-width="1.4" opacity=".5"/><path d="M4 108 q10 -6 20 0 t20 0 t20 0" fill="none" stroke="#5AA0D0" stroke-width="2.4" opacity=".4"/>',
    behind:'<path d="M34 46 Q32 26 60 24 Q88 26 86 46 Q84 32 60 31 Q36 32 34 46 Z" fill="#1A1A24"/>',
    head:'<path d="M40 28 Q40 12 60 10 Q80 12 80 28 Q72 18 60 18 Q48 18 40 28 Z" fill="#1A1A24"/><path d="M46 22 Q60 14 74 22 L74 26 Q60 18 46 26 Z" fill="#E8C24A"/><g transform="translate(60 8)"><path d="M0 4 Q-3 -8 0 -16 Q3 -8 0 4z" fill="#2E8A6A"/><ellipse cx="0" cy="-13" rx="3.4" ry="4.6" fill="#2E6AB0"/><ellipse cx="0" cy="-13" rx="1.8" ry="2.6" fill="#E8A030"/><circle cx="0" cy="-13" r="1" fill="#1A4A8A"/></g>',
    prop:'<g transform="translate(14 82) rotate(24)"><rect x="0" y="0" width="40" height="4.4" rx="2.2" fill="#C98A34" stroke="#8A5E22" stroke-width=".8"/><circle cx="10" cy="2.2" r="1" fill="#6A4418"/><circle cx="18" cy="2.2" r="1" fill="#6A4418"/><circle cx="26" cy="2.2" r="1" fill="#6A4418"/><circle cx="34" cy="2.2" r="1" fill="#6A4418"/></g><g transform="translate(97 46)"><circle r="17" fill="#FFD34D" opacity=".24"/><circle r="13" fill="none" stroke="#F0A62A" stroke-width="3.4"/><circle r="13" fill="none" stroke="#FFE59A" stroke-width="1.2"/><circle r="5.6" fill="none" stroke="#F0A62A" stroke-width="2.4"/><g stroke="#FFD34D" stroke-width="1.7">'
      +'<line x1="0" y1="-13" x2="0" y2="-5.6"/><line x1="0" y1="13" x2="0" y2="5.6"/><line x1="-13" y1="0" x2="-5.6" y2="0"/><line x1="13" y1="0" x2="5.6" y2="0"/><line x1="-9.2" y1="-9.2" x2="-4" y2="-4"/><line x1="9.2" y1="9.2" x2="4" y2="4"/><line x1="9.2" y1="-9.2" x2="4" y2="-4"/><line x1="-9.2" y1="9.2" x2="-4" y2="4"/></g>'
      +'<g fill="#FFD34D"><path d="M0 -17 l2.4 3.6 -4.8 0z"/><path d="M0 17 l2.4 -3.6 -4.8 0z"/><path d="M-17 0 l3.6 2.4 0 -4.8z"/><path d="M17 0 l-3.6 2.4 0 -4.8z"/></g><circle r="2.1" fill="#FF7A4D"/></g>',
    collar:'<path d="M42 120 Q46 92 60 86 Q74 92 78 120 Z" fill="#E0B040"/><path d="M46 92 Q60 104 74 92" fill="none" stroke="#E85A6B" stroke-width="3"/><g fill="#F4ECC0"><circle cx="50" cy="98" r="2.2"/><circle cx="57" cy="102" r="2.2"/><circle cx="64" cy="103" r="2.2"/><circle cx="71" cy="99" r="2.2"/></g>' });
  // ---- Shiva — golden trishul (prongs UP), Ganga from topknot, crescent, third eye, snake, damaru ----
  A.shiva=fig({k:'shiva',skin:'#BCD0E2',jaw:'#9CB4C8',g1:'#D89A44',g2:'#B47826',closed:true,
    backdrop:'<path d="M6 118 L34 66 L50 96 L60 78 L74 100 L96 60 L118 118 Z" fill="#E8EEF4" opacity=".4"/><circle cx="60" cy="42" r="40" fill="#CFE4F0" opacity=".3"/>',
    behind:'<path d="M36 44 Q34 24 60 22 Q86 24 84 44 Q82 30 60 29 Q38 30 36 44 Z" fill="#2A2018"/>',
    head:'<ellipse cx="60" cy="14" rx="9" ry="11" fill="#2A2018"/><path d="M52 8 Q60 -2 68 8 Q64 4 60 4 Q56 4 52 8z" fill="#2A2018"/><path d="M56 12 Q46 20 50 34 Q52 24 58 22" fill="none" stroke="#6AB8E0" stroke-width="2.4" stroke-linecap="round"/><path d="M56 12 Q48 22 52 34" fill="none" stroke="#A8D8F0" stroke-width="1" stroke-linecap="round"/><path d="M50 10 Q40 6 34 12 Q42 12 46 16" fill="#EDEDED" stroke="#D0D0D0" stroke-width="1"/>',
    spec:'<path d="M57 34 h6 M56 37 h8 M57 40 h6" stroke="#E8E8E8" stroke-width="1.3" opacity=".75"/><path d="M60 34 q-2.5 3 0 6 q2.5 -3 0 -6z" fill="#D6362E"/><circle cx="60" cy="37" r="1" fill="#8A1810"/>',
    prop:'<g transform="translate(20 74)"><line x1="0" y1="-6" x2="0" y2="44" stroke="#C99A34" stroke-width="2.4"/><path d="M-9 -6 Q-9 -22 -7 -26 M9 -6 Q9 -22 7 -26 M0 -6 L0 -30 M-7 -26 L-7 -16 M7 -26 L7 -16 M0 -30 L0 -18" stroke="#E8C24A" stroke-width="2.2" fill="none" stroke-linecap="round"/><path d="M-9 -6 Q0 -2 9 -6" stroke="#E8C24A" stroke-width="2.2" fill="none"/></g><g transform="translate(96 96)"><path d="M-5 -6 L5 6 M5 -6 L-5 6" stroke="#8A5E22" stroke-width="2"/><ellipse cx="0" cy="-6" rx="5" ry="2" fill="#D8B87A"/><ellipse cx="0" cy="6" rx="5" ry="2" fill="#D8B87A"/></g><path d="M30 88 Q44 96 60 90 Q76 96 90 88" fill="none" stroke="#2E8A4E" stroke-width="4" stroke-linecap="round"/><path d="M30 88 Q44 96 60 90 Q76 96 90 88" fill="none" stroke="#4EB86E" stroke-width="1.4" stroke-dasharray="1 4"/><path d="M90 88 q5 -2 4 -7 l-4 3z" fill="#2E8A4E"/><circle cx="92" cy="83" r=".8" fill="#FFD34D"/>',
    collar:'<path d="M42 120 Q46 94 60 88 Q74 94 78 120 Z" fill="#C98A34"/>' });
  window.SB_AVATAR_ART = Object.assign(window.SB_AVATAR_ART||{}, A);
})();
