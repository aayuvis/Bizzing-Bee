...
const WV_BAD=new Set(["abactinal","abantes","abelmoschus","abelonian","aberration","abhorrible","abiegh","abiogenetic","abjuration","abolitionism","abrahamical","accelerate","accentuate","acclimated","accomplicity","accomplishments","accouter","accumbent","aciculas","acquaintanceship","acrocyanosis","acronymically","actinide","adaptations","adhesiveness","admixing","adverbially","advocacy","aeromagnetic","aeronautic","affirmation","affronted","aggravate","agonizing","albescent","alibiing","alienate","alimony","allegories","allocated","allocators","allowable","altruism","ambassadress","ametria","amnesiac","amoeboid","amortize","ampersand","amphibians","amphibole","amphibolous","amphisbaena","anaesthetic","anastomosis","anesthetics","angiography","annotates","antagonistic","antediluvian","antemundane","antiamoebic","antibiotic","antibodies","anticipated","antihegelian","antihistamine","antilogging","antimajoritarian","antimisting","antimonarchy","antineutrino","antipathist","antirussian","antithetical","antitipping","anuresis","apartheidlike","apathetically","apodization","apologias","appealability","appealingly","appeasing","appellation","appendagelike","appliers","apposing","appropriated","aptitude","aquavits","araujia","arbitrators","argentina","aristocratism","arizonian","arraignments","arresters","arrogate","ascensive","asinineness","aspersing","assaulted","astatines","attentively","auriscope","authoritatively","autochthonic","autodocking","autopoiesis","backcountry","balletmaster","barbarea","barbicanage","basement","benevolences","betatron","bibliomancy","bimester","bioacoustic","biodosimeter","biodosimetry","bioinspired","bioinvasion","bioorganism","biorefinery","bioresearch","bipinnatifid","biracial","birthright","bisecting","bivouac","blank","bloomsburyan","bootylicious","bouillon","bounteous","boutonniere","brachial","brave","bronchoscopy","bursiform","butanone","calenders","calendrically","camelia","canonicalize","cantatrice","caprioles","carbonic","carolinians","carpetmaking","carryalls","cassetteless","catfishes","cauterizing","cavalierly","cellular","centaurette","chalybite","champagneless","champions","chapiters","characterizing","chasm","chastises","chemotaxonomy","chimneyless","chloroacetic","chylaqueous","cinnabars","citronellic","clapperboard","cleridae","cocrystallize","cologarithm","colonialist","comedienne","comforter","commixing","communicate","communitywise","complaineth","complications","complimenting","compunction","concatenating","concremation","condenser","condescending","congenital","conjugal","connoisseurs","consecutive","consider","constrictors","contortionist","controversial","conventioneers","coracias","corresponded","cottage","counterattacks","counterinsurgencies","countermeasure","counteroffensives","counterrevolutionary","countervailing","courtier","crapulously","crassula","crochetwork","cryolite","cryptograph","crystallographer","cuckoo","culturalist","culturally","curriers","curtailments","cybercapital","cybermarriage","cyberpioneer","cyberpolice","cyclopropene","cytokinetic","cytophysiological","dallying","deaerates","debenture","decentralization","decertify","declarement","declaring","defatigation","defensible","deliverable","deltoidal","demurrals","demurrer","dendrochronology","denunciations","deoxyribose","deprostrate","desensitizing","desertification","despiciency","despises","deteriorated","detesting","deviates","diagonalize","diaphanous","diazepam","differentia","diisopropyl","dijudication","dilettanteism","diligently","dilucidation","disappear","disbursement","disembody","disfigurement","disheartening","disingenuous","dismaler","dispensative","dissympathy","divergement","divination","domiciled","doxastically","dub","eclipsing","effectibility","effervescence","efficient","elaeodochon","electives","electroconductivity","elizabethian","embattle","emperor","emperorlike","emphasis","employers","empressment","enclosure","endocrine","endocrinologists","enjoyers","ennobled","enrapture","enrobing","enrollee","entablement","environmentalists","epiphanically","epistemic","epitome","epsilons","equigranular","erosionally","erythrodermic","erythropoietin","esophageal","esperantism","esquamulose","estrangement","estuaries","etageres","ethnobotany","ethnoracism","ethnoscience","euphonically","eurypteroid","eustachian","evanesce","eve","evolutionary","excitant","excretory","execution","exemplars","exhibitor","exhilaration","expended","expresser","extortion","extracorporeally","extraregular","extrasyllabicity","failure","fainthearted","fascinator","ferromagnetic","feuerbachian","feverishly","flammable","flannel","fluoridation","fooleries","forage","formalizable","fragrant","frontogenesis","fruiterer","genetic","genre","geography","germanophone","gesellschaft","glue","goddessship","grand","granddaughters","grandeur","gravitationally","guardianage","harangue","heinousness","helicopters","hemifission","heraldically","hesitations","hollywoodian","homosexuals","honeybee","horizonless","horror","hotel","humanists","humorist","hungrily","hydrogalvanic","hydrogenise","hydrometallurgically","hyperviolent","hypothetical","hypothetically","ichneumon","idahoan","idioelectric","ilioinguinal","illusionistic","immortality","immunization","immunizes","impermanence","implausibly","imploding","improving","impulseless","impulsion","inaccordant","inadequacy","inarticulate","incapacitate","inchoateness","incombustible","inconsumable","indignant","ineffectual","inequalities","inexpansible","infatuated","infinity","inflating","inflator","infrangible","initials","inscriptions","inscrutable","insecurity","insignia","insinuate","intently","interfere","interhospital","intermeddler","internationalized","interning","interpersonal","interpleader","interring","interrogators","interschool","interstring","interveined","interventions","interweaving","intracerebroventricular","intrapatient","intrasubunit","inundate","invalided","inverting","investigatory","irrelevance","irruptive","ischiopubic","isolable","isopropanol","jacksonesque","jaundices","jhangar","justifications","juvenileness","juveniles","keratohyalin","kilogram","kinesiology","knowledgeable","lacertids","lagoon","lilliputian","lionize","locations","logophilia","lucid","lyceum","magazineland","magicalness","magnicaudate","maltreatment","mammal","marathoning","marionette","martinete","maximized","meaningfully","medicating","megafinance","megohmmeter","metamagnetization","mexicanness","microbes","microfissure","microindustry","micropaleontologic","microserver","microtubing","milieu","millikanian","millikelvin","misbehaving","misinterpretation","moneyless","monopolylike","monoracially","mortgaging","mountainside","multiantenna","multicamera","multicentric","multifrontal","multiheaded","multinodular","multiorganizational","multiplicity","multisoliton","multistrand","multitowered","multivendor","mystique","nanoantenna","nanoproduct","nationality","negativistic","neurologic","nevertheless","noctambulist","non-luminous","nonadverbial","nonaffected","nonallergic","nonartistic","nonblinking","noncarnivore","noncausative","noncompleted","noncontacted","noncrippled","nondeclared","nondeviator","nondiegetic","nondisplayed","nondormancy","nonemigrant","nonepisodic","nonfalsified","nonfamiliar","nonfestival","nonflatulent","nongraduate","nonhepatocellular","nonidiomatic","noninfecting","noningested","noninjurious","noninvesting","noninvolved","nonmagazine","nonmemorized","nonnuclear","nonnucleated","nonoxidized","nonpeptidic","nonplaintiff","nonportable","nonpractical","nonpurchaser","nonrecorded","nonriverine","nonsatirical","nonsectional","nonspatially","nonspecular","nontraditionalistic","notable","novelist","nullities","numerical","observation","obsolescence","obtention","oceanography","octacoordinated","octopuslike","oecanthus","olive","olympia","omnipresent","onion","operators","ophthalmology","ordering","organization","ornamentation","ornithochory","orology","orthodox","ostracise","overages","overconstrain","overdelicate","overprepare","overvaluation","panacea","pandiatonic","paragnathous","paranematic","paranoids","passionately","pastiches","pathetically","pathogens","patronizes","paw","peach","penalty","percolated","perestroika","periodically","periphrasic","peristome","perpetuation","perspective","perturbations","phantomwise","pheasantlike","phenomenally","philanthropists","philately","phonology","phyllitis","pieridae","placableness","plenipotentiary","pneumatique","pole","police","polyethylene","porridge","postapproval","postcardware","postcranium","postmarriage","postrelease","postsymbolic","posttemporal","potentialize","powerlessly","preferences","prelatically","primeval","prismatic","pristineness","privately","procyclical","progressives","prolactinoma","promotional","proof","prophetlike","proresearch","protistan","provocative","provocatively","provostship","psychodermatologic","pub","punitive","pyaemia","pyramidlike","quarrying","quasienergy","quasimusical","quasithermodynamic","quinsyberry","quizzicality","quotable","raisin","ratiocination","rationals","reallocating","recirculate","reconditioned","reconstructing","redirectable","redistributed","reflectorize","reimburse","reinspection","rejectaneous","relationlike","relative","relentlessly","relevancy","reliability","remarries","remembering","reorient","replenishment","republicanize","repudiating","resonance","resourcefulness","retorts","revelations","reverted","revivalist","rhombus","ricochet","riskiest","roadability","roomette","rub","saltigrade","salvation","saw","sawdust","schadenfreude","schoolhouse","scrutiny","scullery","seiche","self-sabotage","semipalmated","semitrailer","sensitivities","sententious","sessionless","sextuplicate","shaanxi","shackle","siesta","sip","situations","six","socialist","socioeconomic","sociologist","solicitous","solidified","solvability","solvableness","somberly","spa","spasmodic","specificity","specifics","spectator","statesmanship","static","sterility","stesichorus","subcomponent","subcontractor","subgroupoid","subindicate","suburbanites","successfully","sufficiency","suffragettes","superarrival","superfamous","supermachine","superman","supermonkey","supermundane","superstation","supported","surpluses","syllogism","sympathizer","symphonically","syndicating","synesthesia","tachypacing","tactician","taxidermize","telemetry","teletutorial","telogenesis","temerarious","temporizing","tenacity","terraceless","testimonial","theocracy","theocratical","theologically","thermonuclear","thioacetate","thoracically","tighten","tip","tirade","tolerable","toothbrush","tourniquet","transaudient","transcription","treasure","troubleshooting","trustworthiness","trypanosomic","tub","umbilical","umbrella","unacidified","unactionable","unaggregated","unagreeably","unaltered","unambitious","unapostolic","unappetising","unappreciated","unassembled","unassessable","unavailable","unboycotted","unbuildable","uncalculated","uncensorable","unceremonious","uncolonized","unconsecrate","undenominational","undensitized","underaction","undercutting","undimerized","undiscovered","unedited","unenergetically","unfashioned","unfortunate","ungentrified","ungroundable","unhousedness","unifoliolate","uninsurable","unionized","unlaughingly","unmanifested","unneeded","unpityingly","unpretreated","unpreviewed","unrecruited","unregulated","unremembrance","unrenovated","unrestricted","unshakable","unslackened","unsolidified","unspankable","untheatrical","unthinkingly","untouchably","untrammelled","untreatably","untrembling","unwaveringly","unweaponized","unwearyingly","vapourizable","variability","vegetable","venisonburger","versicolour","versionitis","virtualness","vivisepulture","vociferously","voltammetry","volumescope","vomiting","whether","who","won","wrongheadedly","yacht","yesterseason","zoochemical","zymurgy"]);
