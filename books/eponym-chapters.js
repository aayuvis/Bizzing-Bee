/* Volume 19 — Named After Someone: the eponyms of English.
   Every word here is pulled from the app's eponym-tagged library (t:['eponyms'])
   with its own definition, sentence, pronunciation, memory hook and origin, so no
   word data is invented. The teaching prose is authored. Shape matches
   SB_CONCEPTS chapters (category/title/difficulty/concept/method/cards/words) so
   mkbooks.js can treat it like any other chapter source. Built by
   voice/pipeline/eponym-build.js. APPEND ONLY. */
window.SB_EPONYMS = [
 {
  "category": "Words from People's Names",
  "title": "Gods and heroes — the Greek names inside English",
  "difficulty": "medium",
  "concept": "An eponym is a word made from somebody's name, and the oldest ones in English are not people at all: they are Greek gods, heroes and monsters. That matters at the microphone, because the spelling follows the NAME, not the sound. Atlas held up the sky, so atlas keeps his single t. Echo was a nymph, so echo keeps her Greek ch.",
  "method": "<div class='trick'><b>HYGIENE</b></div>\n<b>Say it.</b> HY-jeen\n<b>Ask.</b> is a name hiding in here?\n<b>The name.</b> Hygieia, the Greek goddess of health\n<b>Read the name.</b> H · Y · G · I · E · I · A gives you hygie-\n<b>Finish.</b> hygie + ne\n<b>Check.</b> the y is Greek, never an i",
  "cards": [
   {
    "title": "Why a name is a gift",
    "body": "Most words make you choose between spellings. A name does not: it was fixed centuries before the word existed, and nobody is allowed to respell it. Once you spot the name, the hard half of the word is already decided."
   },
   {
    "title": "The Greek fingerprints",
    "body": "Greek names bring Greek letters with them. y where you expect i (hygiene, python), ch for a k sound (echo, chimera), ph for f (phoenix), and the plain single consonant where English would double it (atlas, siren)."
   },
   {
    "title": "Ask the judge for the origin",
    "body": "Origin is the most useful question you can ask about an eponym, because the answer often IS the spelling. 'From Greek mythology' tells you to expect y, ch and ph. 'From a French chemist' tells you to expect a silent ending."
   },
   {
    "title": "The trap: the sound drifts, the name does not",
    "body": "tantalize sounds like it starts tan-, and Tantalus starts Tan-, so it holds. But narcissism sounds like nar-si-sism and Narcissus has TWO s's in the middle and one at the end of the stem: narciss + ism. Say the name, not the word."
   }
  ],
  "words": [
   {
 ...
 {
  "category": "Words from People's Names",
  "title": "Rome on the calendar — gods who became ordinary words",
  "difficulty": "medium",
  "concept": "Rome left its gods all over the English year and the English temperament. Janus, the two-faced god of doorways, gave January. Ceres, goddess of grain, gave cereal. Vulcan gave volcano. Because these arrive through Latin rather than Greek, they behave differently: no y, no ch, and a Latin ending bolted on the back.",
  "method": "<div class='trick'><b>CEREAL</b></div>\n<b>Say it.</b> SEER-ee-uhl\n<b>The name.</b> Ceres, the Roman goddess of grain\n<b>Read the name.</b> C · E · R · E · S gives you cere-\n<b>Add the Latin ending.</b> cere + al\n<b>Check.</b> not serial — that is a different word about series",
  "cards": [
   {
    "title": "Latin eponyms take an ending",
    "body": "A Greek eponym is often the bare name (atlas, echo). A Latin one usually wears a suffix: -al on cereal, -ial on martial, -ial on jovial, -ine on saturnine. Find the name, then decide the ending separately."
   },
   {
    "title": "The god decides the mood",
    "body": "Jove was cheerful, so jovial means cheerful. Saturn was cold and slow, so saturnine means gloomy. Mercury was quick, so mercurial means changeable. Mars made war, so martial means military. Learn the god and you get the meaning free."
   },
   {
    "title": "Homophone alert",
    "body": "cereal and serial sound identical and both are real words. cereal comes from Ceres and means grain. serial comes from series and means one after another. If the judge's sentence is about breakfast, it is Ceres."
   },
   {
    "title": "The months are eponyms too",
    "body": "January from Janus, March from Mars, May from Maia, June from Juno, July from Julius Caesar, August from Augustus. Six of the twelve months are named after somebody, which is why they capitalise."
   }
  ],
  "words": [
   {
 ...
 {
  "category": "Words from People's Names",
  "title": "The units of science — surnames turned into measurements",
  "difficulty": "hard",
  "concept": "Science pays its debts by naming units after people, and it does it in a strict pattern: the unit is written in lower case even though the person was capitalised. Volta gave volt, Ampère gave ampere, Ohm gave ohm, Hertz gave hertz. These are the most predictable eponyms in English, because a surname is spelt exactly one way.",
  "method": "<div class='trick'><b>AMPERE</b></div>\n<b>Say it.</b> AM-peer\n<b>The name.</b> André-Marie Ampère, French physicist\n<b>Read the surname.</b> A · M · P · E · R · E — the word IS the name\n<b>Drop the accent.</b> English writes ampere, not ampère\n<b>Check.</b> no double p, no -ear ending",
  "cards": [
   {
    "title": "The unit loses the capital, keeps the letters",
    "body": "Newton the man, newton the unit. Pascal the man, pascal the unit. Curie, Kelvin, Tesla, Coulomb, Farad — every one drops its capital and keeps every letter. That is the whole rule."
   },
   {
    "title": "Accents fall off at the border",
    "body": "Ampère, Réaumur and Celsius arrived with accents and lost them: ampere, reaumur, celsius. So the pronunciation drifts away from the spelling, and you spell the plain English form."
   },
   {
    "title": "Two men who became verbs",
    "body": "Pasteur gave pasteurize and Galvani gave galvanize. When a name becomes a verb it takes -ize and keeps the name whole: pasteur + ize, galvan + ize. Note galvanize loses Galvani's final i."
   },
   {
    "title": "Fahrenheit is the hard one",
    "body": "Daniel Fahrenheit's surname carries the German -heit ending: F · A · H · R · E · N · H · E · I · T. Two h's, an ei that says long i, and no y anywhere. Celsius, beside it, is easy."
   }
  ],
  "words": [
   {
 ...
 {
  "category": "Words from People's Names",
  "title": "Inventors and their machines",
  "difficulty": "hard",
  "concept": "When somebody builds a thing, the thing often keeps their name — and their nationality's spelling habits with it. Rudolf Diesel was German, so diesel has the German ie. Joseph Guillotin was French, so guillotine has the French silent ending and the French ll. Count Zeppelin was German again: two p's, two l's, no y.",
  "method": "<div class='trick'><b>GUILLOTINE</b></div>\n<b>Say it.</b> GHEE-uh-teen\n<b>The name.</b> Joseph-Ignace Guillotin, French doctor\n<b>Read the surname.</b> G · U · I · L · L · O · T · I · N\n<b>Add the French ending.</b> guillotin + e\n<b>Check.</b> gui not gi, double l, and the e you cannot hear",
  "cards": [
   {
    "title": "The nationality is the spelling clue",
    "body": "Ask where the inventor was from and you know what to expect. German: ie, double consonants, no silent letters (diesel, zeppelin, bakelite). French: silent final e, ou, ll, -ine (guillotine, limousine). Scottish: mac- (macadam)."
   },
   {
    "title": "Trade names that became words",
    "body": "Jacuzzi, Bakelite and Biro were company names before they were words, so they keep the founder's spelling exactly: two z's in jacuzzi from the Jacuzzi brothers, and Bakelite from Leo Baekeland with the ae flattened to a."
   },
   {
    "title": "The word that sounds nothing like the name",
    "body": "gerrymander is Elbridge Gerry plus salamander, because the electoral district he drew looked like one. So it takes Gerry's double r even though nobody says it that way."
   },
   {
    "title": "When the instrument keeps the maker",
    "body": "Adolphe Sax built it, so it is a saxophone: sax + o + phone, with the Greek -phone stuck on a Belgian surname. Sousa conducted, so it is a sousaphone. The joins are always visible."
   }
  ],
  "words": [
   {
 ...
 {
  "category": "Words from People's Names",
  "title": "What they wore — clothes with a person inside",
  "difficulty": "medium",
  "concept": "Clothing is the friendliest corner of the eponym world, because nearly every garment is named after the aristocrat, general or dancer who wore it first. The Earl of Cardigan gave cardigan. Jules Léotard was a trapeze artist. Charles Macintosh waterproofed cloth — and the coat gained a k he never had.",
  "method": "<div class='trick'><b>MACKINTOSH</b></div>\n<b>Say it.</b> MA-kuhn-tosh\n<b>The name.</b> Charles Macintosh, Scottish chemist\n<b>Watch out.</b> the man is Macintosh; the COAT is mackintosh\n<b>Read it.</b> M · A · C · K · I · N · T · O · S · H\n<b>Check.</b> the raincoat gained a k the chemist never had",
  "cards": [
   {
    "title": "The one that changed spelling",
    "body": "Most eponyms keep the name exactly. mackintosh is the famous exception: the coat took an extra k somewhere in the nineteenth century and kept it. If the sentence is about rain, spell the k."
   },
   {
    "title": "Titles become garments",
    "body": "Cardigan, Raglan and Wellington were all British commanders, and all three gave their titles to something you put on: a buttoned sweater, a sleeve cut to the collar, and a rubber boot. Lower case for the garment, capital for the man."
   },
   {
    "title": "Hats keep their hatters",
    "body": "John B. Stetson made the stetson, and the fedora came from a play called Fédora — so one is a surname and one is a character. Both drop to lower case and keep every letter."
   },
   {
    "title": "The two that hide their people",
    "body": "bloomers are Amelia Bloomer's, and sideburns are General Burnside's — with the two halves of his name swapped round. sideburns is the only eponym in common use that reverses its own person."
   }
  ],
  "words": [
   {
 ...
 {
  "category": "Words from People's Names",
  "title": "What's on the plate — food named after people",
  "difficulty": "medium",
  "concept": "Food eponyms honour the cook, the diner or the dancer. The Earl of Sandwich wanted to eat at the card table. Anna Pavlova danced, and got a meringue. Louis de Béchameil got a sauce, and his sauce kept its French accent long enough to confuse everybody. The rule holds: spell the person.",
  "method": "<div class='trick'><b>BECHAMEL</b></div>\n<b>Say it.</b> bay-shuh-MEL\n<b>The name.</b> Louis de Bechameil, steward to Louis XIV\n<b>Read the name.</b> B · E · C · H · A · M · E · L\n<b>Trim the ending.</b> the sauce drops his -eil for -el\n<b>Check.</b> ch says sh, because it is French",
  "cards": [
   {
    "title": "The dish is lower case, the person is not",
    "body": "A pavlova, a melba, a margherita, a garibaldi. English drops the capital the moment a name becomes a food — which is exactly why the spelling matters: you no longer have the capital to tip you off."
   },
   {
    "title": "Places count too",
    "body": "Some food names come from towns rather than people: frankfurter from Frankfurt, hamburger from Hamburg, tangerine from Tangier, satsuma from Satsuma. Same trick, different kind of name — read the place."
   },
   {
    "title": "The berry with two breeders",
    "body": "loganberry is James Logan's and boysenberry is Rudolph Boysen's. Both keep the surname whole and add -berry, so the join is always visible: logan + berry, boysen + berry."
   },
   {
    "title": "Praline, and the trap in it",
    "body": "praline honours Marshal du Plessis-Praslin, and English simplified his sl to l. One n, one l, and it ends -ine like the French words it travelled with."
   }
  ],
  "words": [
   {
 ...
 {
  "category": "Words from People's Names",
  "title": "Words that judge you — names that became verdicts",
  "difficulty": "hard",
  "concept": "The cruellest eponyms are the ones that turned a person into an accusation. Draco wrote brutal laws, so draconian means brutal. Machiavelli advised princes, so machiavellian means scheming. Captain Boycott was shunned, so boycott means shun. These are long words, but every one of them is a name plus a plain English ending.",
  "method": "<div class='trick'><b>MACHIAVELLIAN</b></div>\n<b>Say it.</b> ma-kee-uh-VEL-ee-uhn\n<b>The name.</b> Niccolo Machiavelli, Florentine writer\n<b>Read the surname.</b> M · A · C · H · I · A · V · E · L · L · I\n<b>Add the ending.</b> machiavelli + an\n<b>Check.</b> chi says kee because it is Italian; the ll is his, not ours",
  "cards": [
   {
    "title": "Split it at the name",
    "body": "Every word here divides cleanly. draco + nian. machiavelli + an. quixot(e) + ic. bowdler + ize. chauvin + ism. Find the join and you only ever have to spell a name and a suffix, never a fourteen-letter word."
   },
   {
    "title": "The fiction counts as much as the fact",
    "body": "Don Quixote was invented, and so were Svengali and Mrs Malaprop — but quixotic, svengali and malapropism follow the same rule. A made-up name is still a name, and it is still fixed."
   },
   {
    "title": "Two verdicts from one country",
    "body": "Sparta was plain and tough, so spartan means bare. Laconia, the region around it, was famous for short answers, so laconic means using few words. Two Greek places, two English insults."
   },
   {
    "title": "The Italian ch that says k",
    "body": "machiavellian and Chianti share it: in Italian, ch before i or e says k. So do not write mackiavellian, and do not soften it to ch. This is the single most missed letter pair in the group."
   }
  ],
  "words": [
   {
    "w": "draconian",
    "say": "dray-KOH-nee-uhn",
 ...
 {
  "category": "Words from People's Names",
  "title": "Flowers with a botanist inside",
  "difficulty": "hard",
  "concept": "Eighteenth-century botanists named plants after each other, and Latin gave every one of them the same ending: -ia. That is a gift, because it means the whole back half of the word is settled before you start. Michel Begon gave begonia; Anders Dahl gave dahlia; Pierre Magnol gave magnolia.",
  "method": "<div class='trick'><b>FUCHSIA</b></div>\n<b>Say it.</b> FYOO-shuh\n<b>The name.</b> Leonhart Fuchs, German botanist\n<b>Read the surname.</b> F · U · C · H · S\n<b>Add the botanist's ending.</b> fuchs + ia\n<b>Check.</b> the letters are chs even though your ear hears sh — this is the most misspelt flower in English",
  "cards": [
   {
    "title": "The -ia is automatic",
    "body": "begonia, dahlia, magnolia, fuchsia, poinsettia, gardenia, zinnia, camellia, wisteria, forsythia, lobelia. Eleven flowers, eleven -ia endings. Spell the surname and add it."
   },
   {
    "title": "Fuchsia is the trap",
    "body": "You hear FYOO-shuh and want to write fuscia or fuschia. Both are wrong. The man was Fuchs — f, u, c, h, s — so the word is f-u-c-h-s-i-a. Say his name out loud before you spell it."
   },
   {
    "title": "Watch the doubled letter",
    "body": "camellia has two l's, from Georg Kamel by way of Latin Camellus. zinnia has two n's, from Johann Zinn. The double belongs to the name, so it survives into the flower."
   },
   {
    "title": "The longest one",
    "body": "bougainvillea honours Louis Antoine de Bougainville, and it keeps every letter of him: b-o-u-g-a-i-n-v-i-l-l-e, then a. Fourteen letters, but only one decision — spell the sailor."
   }
  ],
  "words": [
   {
 ...
 {
  "category": "Words from People's Names",
  "title": "The French set — names that kept their silent letters",
  "difficulty": "hard",
  "concept": "French eponyms are the ones that punish a good ear. Etienne de Silhouette, Francois Mansart, Jean Nicot and Louis Braille all gave their names to English words, and every one of those words carries French spelling habits that your ear cannot hear: a silent final e, ou for oo, ll after i, and -ine on the end.",
  "method": "<div class='trick'><b>SILHOUETTE</b></div>\n<b>Say it.</b> si-luh-WET\n<b>The name.</b> Etienne de Silhouette, French finance minister\n<b>Read the name.</b> S · I · L · H · O · U · E · T · T · E\n<b>Find the silent h.</b> between the l and the o, where you hear nothing\n<b>Check.</b> -ouette, with two t's and an e — the classic French tail",
  "cards": [
   {
    "title": "The silent h nobody expects",
    "body": "silhouette has an h you cannot hear, sitting between l and o. It is there because his name had it. This one letter accounts for most failed attempts at the word."
   },
   {
    "title": "-ine is the French chemistry ending",
    "body": "Jean Nicot gave nicotine, and the pattern repeats across French science words: -ine, never -in or -een. Say NIK-uh-teen and write nicotine."
   },
   {
    "title": "Six letters, one blind man",
    "body": "Louis Braille lost his sight at three and built the alphabet that carries his name. braille keeps his ai and his ll, and drops only his capital. Franz Mesmer, next door in Vienna, gave mesmerize the same way: mesmer + ize."
   },
   {
    "title": "Roofs, cars and cologne",
    "body": "mansard from Francois Mansart the architect, limousine from the Limousin region, cologne from the city of Cologne, bayonet from Bayonne where they were forged. Place names behave exactly like people's names: read the place, add the ending."
   }
  ],
  "words": [
   {
    "w": "silhouette",
    "say": "s-ih-l-uh-w-EH-t",
 ...
 {
  "category": "Words from People's Names",
  "title": "At the microphone — the eponym checklist",
  "difficulty": "hard",
  "concept": "You will not be told a word is an eponym. You have to hear it. The signals are a proper-noun rhythm, an ending bolted onto something that sounds like a surname, and a definition that mentions a person, a place or a story. The moment you suspect one, stop guessing at sounds and start spelling a name.",
  "method": "<div class='trick'><b>THE FOUR QUESTIONS</b></div>\n<b>1. Origin?</b> a country tells you the letter habits to expect\n<b>2. Is there a name in it?</b> say the word slowly and listen for a surname\n<b>3. Where does the name end?</b> that is where the suffix starts\n<b>4. Which suffix?</b> -ian, -ic, -ism, -ize, -ia, -ine, or nothing at all\n<b>Then spell the name first, the ending second.</b>",
  "cards": [
   {
    "title": "Ask for the origin, always",
    "body": "For an eponym the origin answer is worth more than the definition. 'From the name of a Scottish engineer' hands you mac-. 'From Greek mythology' hands you y and ch. Ask, then decide."
   },
   {
    "title": "Ask for the sentence too",
    "body": "The sentence often names the person outright: 'The doctor pasteurized the milk, as Louis Pasteur had shown.' A judge is allowed to give you the name, and the name is the spelling."
   },
   {
    "title": "The endings, in order of frequency",
    "body": "-ia for plants, -ian and -esque for people's manners, -ic for temperaments, -ism and -ist for beliefs, -ize for what somebody did, -ine for French chemistry, and bare for gods and garments."
   },
   {
    "title": "When your ear and the name disagree, trust the name",
    "body": "fuchsia sounds like fewsha. gerrymander sounds like jerrymander. mackintosh sounds like one k. In every case the name wins, because a name is the one thing in English that nobody is allowed to respell."
   }
  ],
  "words": [
   {
