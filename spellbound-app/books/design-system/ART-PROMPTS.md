...
|---|---|---|---|
| Front covers (ensemble keyframe) | **18** | 2550×3300 | unique per volume |
| World divider pages | **18** | 2550×3300 | unique per volume |
| Chapter storyboard openers | **176** | 2175×2500 | unique per chapter (template + variables) |
| Back-of-book cast posters | **16** | 2550×3300 | unique per volume |
| Theme hero half-pages (Vol. 18) | **12** | 2550×1650 | unique per theme |
| World scenery strips | **39 unique** (13 worlds × 3 registers) | 2175×360 | reused across ~445 placements |
| Character model sheets (Bizzy, Vex) | **2** | 2048×2048 | reference images for every other generation |
| **Total unique generations** | **281** | | |
...
## The 13 worlds (scene vocabulary — insert per prompt)
...
| the Grand Trunk Road | a dusty golden highway to the horizon, an enormous banyan with hanging aerial roots, carved stone milestones, paper kites, a distant temple spire and minaret |
...
**T5 — THEME HERO (12×, Vol. 18).** Half-page wide: Melody the songbird
...
| 14 The Grand Trunk Road | Grand Trunk Road | 3 | Naga | Baloo 2 |
| 15 Far-Flung Words | Wide Strait | 3 | Mic | Baloo 2 |
| 16 The Word Factory | Engine Room | 3 | Maestro | Quicksand |
| 17 As Busy as a Bee | Meadow | 2 | Popcorn | Fredoka |
| 18 Say It Like a Champion | Big Stage | 3 | Melody | Righteous |

Chapter-level variables for the 176 openers (world visited, mood sequence,
...
excited where present). Vol. 14 is the exception: it pins its own ring (`cyc`)
so the Grand Trunk Road recurs every other chapter, and it pins its own crew
(`cast`) so inserting it never reshuffled the volumes after it.
