...
- The shelf shows the REAL cover — masthead, kicker, title, tag and fact pills composed
  ...
  swaps the house Ghibli style for a seinen-manga / Spider-Verse register — hard ink,
  halftone, offset channels, no chibi — for the advanced half of the library. Every
  prompt must forbid text: the model will happily letter a brass plate if you name one.
