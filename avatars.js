...
(function(){
  ...
  const AV = [
    ...
    ['thor','Thor','gods','free'],['poseidon','Poseidon','gods','epic'],['ra','Ra','gods','epic'],['athena','Athena','gods','epic'],['hades','Hades','gods','epic'],['anubis','Anubis','gods','epic'],['zeus','Zeus','gods','legendary'],['rama','Rama','gods','legendary'],['odin','Odin','gods','legendary'],['krishna','Krishna','gods','legendary'],['shiva','Shiva','gods','legendary'],
