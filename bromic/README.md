...
| `deck.html` | Source of the visual deck (image data is injected at build time, not stored inline) |
...
| `build-deck.py` | Inlines `boards/*.jpg` as data URIs into `deck.html` → `deck-final.html` |
